# settings-usage-management-entry Specification

## Purpose

TBD - created by archiving change move-admin-entry-to-settings-usage-management. Update Purpose after archive.
