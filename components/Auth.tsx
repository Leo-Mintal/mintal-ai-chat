        ...
        >
          <div className="p-8 sm:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="animate-slide-up-bouncy pt-2" style={{ animationDelay: isLogin ? '0.3s' : '0.4s' }}>
                <Button
                  type="submit"
                  loading={loading}
            ...
            <div className="mt-8 text-center animate-slide-up-bouncy" style={{ animationDelay: isLogin ? '0.4s' : '0.5s' }}>
              <button
                onClick={switchMode}
