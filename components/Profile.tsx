...
export const Profile: React.FC<ProfileProps> = ({
  ...
  const avatarSrc =
    user.avatar ||
    `https://api.dicebear.com/7.x/notionists/svg?seed=${encodeURIComponent(name || "mintal")}&backgroundColor=FFD54F,FFB74D,FF8A65`;
  ...
  return (
    <div className="flex flex-col h-full bg-cream-50/50 dark:bg-transparent animate-pop-in overflow-y-auto custom-scrollbar">
      ...
      <div className="max-w-xl mx-auto w-full p-6 sm:p-10">
        <div
          className="bg-white/70 dark:bg-night-card/60 backdrop-blur-md border-[2px] border-white dark:border-white/10 rounded-[48px] p-10 shadow-soft dark:shadow-night animate-slide-up-bouncy"
        ...
        >
          ...
          <div className="space-y-8">
            ...
            <div
              className="pt-4 flex gap-3 animate-slide-up-bouncy"
