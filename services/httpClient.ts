...
const refreshAccessToken = async (): Promise<string> => {
  ...
  const data = unwrapSuccessData<Record<string, unknown>>(
    payload,
    response.status,
  );
